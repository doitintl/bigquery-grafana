...
import { CustomVariable } from 'grafana/app/features/templating/custom_variable';


describe('BigQueryDatasource', () => {
  const instanceSettings = { name: 'bigquery' };
  ...
  describe('When interpolating variables', () => {
    beforeEach(() => {
   //TODO fix me   ctx.variable = new CustomVariable({}, {});
    });
